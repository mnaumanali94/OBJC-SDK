...
/**
* Completion block definition for asynchronous call to Get Headers */
typedef void (^CompletedGetHeaders)(BOOL success, HttpContext* context, NSError* error);

/**
* TODO: type endpoint description here
*/
- (void) getHeadersWithCompletionBlock:(CompletedGetHeaders) onCompleted;
