...
-(void) testSimpleQuery {
    ...
    BOOL boolean = [[NSNumber numberWithBool: [@"true" boolValue]]boolValue];
    int number = [[NSNumber numberWithInteger: [@"4" intValue]]intValue];
...
-(void) testMultipleParams {
    ...
    XCTestExpectation *expectation =[self expectationWithDescription:@"High Expectations"];
    // Parameters for the API call
    int number = [[NSNumber numberWithInteger: [@"123412312" intValue]]intValue];
    double precision = [[NSNumber numberWithDouble: [@"1112.34" doubleValue]]doubleValue];
